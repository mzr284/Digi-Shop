    ...
    return(
        <div className="main-container translate-y-25 mb-50 flex flex-col items-center gap-4">
            <div className="w-full flex flex-col justify-center items-center gap-2">
                <div className="font-medium text-[18px] flex gap-20 w-5/6 justify-between text-center">
                    <div className="flex flex-col items-center gap-2">
                       <img className="w-25 rounded-full transform hover:scale-90 transition-transform duration-250 cursor-pointer"

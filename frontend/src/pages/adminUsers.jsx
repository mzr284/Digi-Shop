...
export default function AdminUsers(){
    ...
    return(
        ...
        <div className='-translate-y-10 -translate-x-10 z-600'><Notification/></div>
                    ...
                    users.map((user, idx)=>(                        
                        <div className='flex justify-between items-center bg-gray-50 py-0.5' key={idx}>
                            ...
                            {  editingId === user._id ? permissionState ?
                                <div className='z-300 absolute translate-y-9 text-center text-gray-700 bg-gray-100 border border-gray-300 rounded-sm'>
                            ...
                            }
                            {
                                ...
                                <div className='z-300 absolute translate-y-3 text-center text-gray-700 bg-gray-100 border border-gray-300 rounded-sm'>
                                    <ul className='flex flex-col gap-2 py-1 px-2'>

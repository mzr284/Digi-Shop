...
export default function Header(){
    ...
    return(
        <div id="header">
            ...
            <div className={`fixed z-1401 left-0 bg-white shadow px-2 py-2 w-70 h-full ${sidebar? 'translate-x-0' : '-translate-x-full'}
            transition-transform duration-500`}>
                <div className="absolute right-0 top-5 bg-green-500 text-white pr-1 pl-4 py-1 rounded-l-full shadow cursor-pointer h-8 w-12 group" onClick={()=>setSidebar(false)}>
        ...
        <div className="header z-1010 fixed top-0 w-full bg-gray-200 flex justify-between py-2 px-8 items-center shadow">
            <div>

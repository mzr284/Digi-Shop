export default function WelcomeAdmin(){
    ...
    return(
        <div className="translate-y-17 flex flex-col gap-7 justify-center items-center">
            ...
            <p className="font-medium text-center w-200 text-[17px] text-gray-600"><span className="text-xl text-gray-800">Hi</span>, <span className="font-serif text-[21px] text-shadow-md text-gray-800">Mohammad Amin</span>
            <tr/>
